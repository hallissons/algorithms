...
public class TwoSumIntervalTests {
	...
	public void testBasicInterval(){
		List<String> entities = FileUtils.readAllLines("br/com/studies/algorithms/week6/algo1-programming_prob-2sum_simple.txt");
	...
	public void testInterval(){
		List<String> entities = FileUtils.readAllLines("br/com/studies/algorithms/week6/algo1-programming_prob-2sum.txt");
		TwoSumInterval twoSumInterval = new TwoSumInterval(entities, BEGIN_INTER, END_INTER);
