...
public class MedianMaintenceTests {
	...
	public void testSumMedians1() {		
		List<String> entities = FileUtils.readAllLines("br/com/studies/algorithms/week6/median-maintence-tests1.txt");
	...
	public void testSumMedians2() {		
		List<String> entities = FileUtils.readAllLines("br/com/studies/algorithms/week6/median-maintence-tests2.txt");
		long sum = sumMedians(entities);
	...
	public void testSumMediansF() {		
		List<String> entities = FileUtils.readAllLines("br/com/studies/algorithms/week6/Median.txt");
		long sum = sumMedians(entities);
